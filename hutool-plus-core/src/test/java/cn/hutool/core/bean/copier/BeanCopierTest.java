...
public class BeanCopierTest {
	...
	public void beanToBeanNotOverrideTest() {
		...
		final BeanCopier<A, B> copier = BeanCopier.create(a, b, CopyOptions.create().setOverride(false));
		copier.copy();
	...
	public void beanToBeanOverrideTest() {
		...
		final BeanCopier<A, B> copier = BeanCopier.create(a, b, CopyOptions.create());
		copier.copy();
	...
	public void issues2484Test() {
		...
		BeanCopier<A, B> copier = BeanCopier.create(a, b, CopyOptions.create().setOverride(false));
		copier.copy();
		Assert.assertEquals("123", b.getValue());
